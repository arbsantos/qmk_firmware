 ...
 *
 * Modified version for ISO layout
 *
 ...
 */
    ...
    enum led_location_map {
        ...
        LED_K,      // 47, K, k62
        LED_COMM,   // 48, ,, k64
        LED_RALT,   // 49, Alt_R, k95 -> my FN1
        LED_F9,     // 50, F9, ka6
        LED_9,      // 51, 9, k77
        LED_O,      // 52, O, k70
        LED_L,      // 53, L, k72
        LED_DOT,    // 54, ., k74
        LED_FN,     // 55, FN, k92 -> my RWin
        LED_F10,    // 56, F10, ka7
        LED_0,      // 57, 0, k87
        LED_P,      // 58, P, k80
        LED_SCLN,   // 59, ;, k82
    ...
    const uint8_t LED_LIST_RGB_OPTS[] = {
        LED_1, LED_2,
        LED_Q, LED_W, LED_E, LED_R, LED_U, LED_I, LED_O, LED_P,
        LED_A, LED_S, LED_D, LED_G, LED_K,
        LED_X, LED_B,
